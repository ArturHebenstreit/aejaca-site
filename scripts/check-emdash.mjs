...
// encja &mdash; nie ma prawa pojawic sie w tresci, w komentarzach, w kodzie
...
for (const file of files) {
  ...
  if (!src.includes("—") && !src.includes("&mdash;")) continue;
  src.split("\n").forEach((line, i) => {
    if (!line.includes("—") && !line.includes("&mdash;")) return;
...
if (problems.length) {
  ...
  console.error('Zamien "—" na krotki myslnik, przecinek, nawias albo kropke.');
