...
export const SERVICES_FULL = [
  ...
  },
  {
    ...
    specs: [
      ...
      { label: L("Grawer", "Engraving", "Gravur"), value: L("Tekst, wzór albo oba. Laserem, tylko przy wykończeniu jubilerskim", "Text, pattern or both. Laser, only with the jewellery finish", "Text, Muster oder beides. Laser, nur beim Juwelierfinish") },
