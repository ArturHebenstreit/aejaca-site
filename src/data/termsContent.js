    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Karta jest ważna 12 miesięcy od dnia jej wydania. Data ważności jest wskazana na Karcie i możliwa do sprawdzenia w Serwisie. Po upływie terminu ważności Karta wygasa, a niewykorzystane środki nie podlegają zwrotowi ani wypłacie. Sprzedawca nie przedłuża terminu ważności Karty.",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "The Card is valid for 12 months from the date of issue. The expiry date is stated on the Card and can be checked in the Service. After that date the Card expires and any unused balance is neither refunded nor paid out. The Seller does not extend the validity of a Card.",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Die Karte ist 12 Monate ab Ausstellung gültig. Das Ablaufdatum steht auf der Karte und lässt sich im Service prüfen. Nach Ablauf verfällt die Karte, nicht genutztes Guthaben wird weder erstattet noch ausgezahlt. Der Verkäufer verlängert die Gültigkeit nicht.",
