    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Zamówienie w euro opłacane jest przelewem bankowym na rachunek Sprzedawcy wskazany po złożeniu zamówienia oraz przesłany Klientowi wiadomością elektroniczną. Kwota w euro jest wiążąca przez 7 dni od złożenia zamówienia. Wpływ środków Sprzedawca potwierdza samodzielnie po zaksięgowaniu na rachunku i niezwłocznie przesyła Klientowi potwierdzenie przyjęcia należności wraz z informacją o rozpoczęciu realizacji.",
          ...
          "Koszt dostawy podawany jest odrębnie w Wycenie i doliczany do ceny.",
        ],
      },
      {
        n: "8",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "An order priced in euro is paid by bank transfer to the account indicated after the order is placed and sent to the Customer by email. The amount in euro is binding for 7 days from placing the order. The Seller confirms receipt personally once the funds clear and promptly sends the Customer a confirmation of receipt together with notice that production has started.",
          ...
          "Delivery cost is stated separately in the Quotation and added to the price.",
        ],
      },
      {
        n: "8",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Eine in Euro ausgewiesene Bestellung wird per Banküberweisung auf das nach der Bestellung mitgeteilte und dem Kunden per E-Mail zugesandte Konto bezahlt. Der Betrag in Euro ist ab Bestellung 7 Tage verbindlich. Den Geldeingang bestätigt der Verkäufer nach Gutschrift persönlich und sendet dem Kunden unverzüglich eine Zahlungsbestätigung samt Hinweis auf den Fertigungsbeginn.",
          ...
          "Die Lieferkosten werden im Angebot gesondert ausgewiesen und dem Preis hinzugerechnet.",
        ],
      },
      {
        n: "8",
