// ============================================================
// DANE STARTOWE KATALOGU
// ============================================================
// Trzy przykladowe pozycje, ktorymi zapelniamy pusta baze, zeby dalo sie
// przejsc caly sklep od karty produktu po platnosc, zanim wejdzie prawdziwy
// asortyment. To jedyne miejsce w repozytorium z trescia produktu: sklep
// czyta katalog z bazy, a nie stad.
//
// Wgranie do bazy: `npm run products:seed`. Pozycje trafiaja tam jako
// nieaktywne, wiec nie pojawia sie w sklepie, dopoki ich nie wlaczysz.

import { OFFER_KIND } from "./offerKinds.js";
