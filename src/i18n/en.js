export default {
  ...
  home: {
    ...
    jewelryDesc: "Silver, gold, natural gemstones. Every piece handcrafted, just for you.",
    jewelryBtn: "Discover jewelry",
    studioTitle: "sTuDiO",
    studioSubtitle: "AEJaCA sTuDiO",
    studioDesc: "3D printing, laser engraving, CNC milling. Get an instant quote online.",
  ...
  jewelry: {
    ...
    aboutP1: "AEJaCA represents the artistic and luxury side of the brand. Every piece of jewelry is handcrafted with meticulous attention to detail, combining traditional silversmithing techniques with in-house 3D modeling in Rhino and Fusion 360. Organic jewelry forms are designed from scratch — from a sketch or photo to a file ready for printing or casting.",
    aboutP2: "We believe that jewelry should carry meaning. Each creation follows a complete cycle: consultation → CAD model → wax prototype or 3D print → lost-wax casting → hand finishing → stone setting. Every step is guided by passion and precision.",
    ...
    portfolio: {
      ...
      items: [
        ...
        { img: "/img/portfolio/jewelry-web/sea-snail-pendant.webp", title: "Sea snail pendant", category: "custom", desc: "Custom-made pendant shaped like a symbolic sea snail, 925 silver, on a black natural leather cord." },
        { img: "/img/portfolio/jewelry-web/gold-band-585.webp", title: "Gold wedding band 585", category: "rings", desc: "Classic 585 gold band, 4mm wide, polished to a high shine." },
        { img: "/img/portfolio/jewelry-web/garnet-ring-585.webp", title: "Garnet ring", category: "rings", desc: "585 gold ring with a central 1.2 ct red garnet flanked by six 2.5mm cubic zirconias." },
  ...
  studio: {
    ...
    aboutP1: "AEJaCA sTuDiO is the technical and engineering arm of the brand. We combine digital fabrication with in-house 3D modeling (Rhino, Fusion 360) — designing both organic jewelry forms and functional technical parts (parametric design, mechanical tolerances, reverse engineering). We don't just print files you upload.",
    aboutP2: "Whether you need a single prototype, a small production run, or a fully customized technical solution, we start from your sketch, photo, or idea and take the project all the way from CAD model to finished product.",
    ...
    services: [
      "3D modeling from sketch / photo / idea (Rhino, Fusion 360)",
      "Parametric design, mechanical tolerances & reverse engineering",
  ...
  contact: {
    ...
    thankYou: "Thank you!",
    thankYouText: "We'll get back to you shortly. For urgent matters, email us directly at contact@aejaca.com",
