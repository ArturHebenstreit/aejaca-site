export default {
  ...
  a11y: {
    ...
    krokiZamowienia: "Kroki zamówienia, przewijane w bok",
    closeLightbox: "Zamknij powiększenie",
    newsletter: "Zapis na newsletter",
    newsletterStopka: "Zapis na newsletter w stopce",
    listaWpisow: "Lista wpisów",
  ...
  nav: {
    ...
    jewelrySections: [
      ...
      { label: "Sklep", to: "/shop/jewelry/" },
      { label: "Sklep Etsy", href: "https://aejacashop.etsy.com" },
    ...
    studioSections: [
      { label: "Sklep", to: "/shop/studio/" },
      { label: "Sklep Etsy Studio", href: "https://aejaca2studio.etsy.com" },
