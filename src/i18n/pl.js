export default {
  nav: {
    ...
    jewelrySections: [
      ...
      { label: "Produkty i usługi", to: "/shop/jewelry/" },
      ...
      { label: "Słownik", to: "/glossary/?category=jewelry" },
    ...
    studioSections: [
      { label: "Produkty i usługi", to: "/shop/studio/" },
      ...
      { label: "Porady", id: "tips" },
      { label: "Słownik", to: "/glossary/?category=studio" },
  ...
  jewelry: {
    ...
    aboutP1: "AEJaCA reprezentuje artystyczną i luksusową stronę marki. Każdy element biżuterii jest ręcznie tworzony z najwyższą dbałością o detale, łącząc tradycyjne techniki złotnicze z własnym modelowaniem 3D w Rhino i Fusion 360. Organiczne formy biżuteryjne projektujemy od podstaw — od szkicu lub zdjęcia po plik gotowy do wydruku lub odlewu.",
    aboutP2: "Wierzymy, że biżuteria powinna nieść znaczenie. Każda kreacja przechodzi pełny cykl: konsultacja → model CAD → prototyp woskowy lub wydruk 3D → odlew metodą traconego wosku → ręczna obróbka → osadzenie kamieni. Każdy krok jest kierowany pasją i precyzją.",
    ...
    portfolio: {
      ...
      items: [
        ...
        { img: "/img/portfolio/jewelry-web/sea-snail-pendant-v3.webp", title: "Wisiorek ślimak morski", category: "custom", desc: "Wisiorek wykonany na specjalne zamówienie w kształcie symbolicznego ślimaka morskiego, srebro 925, na czarnym naturalnym rzemieniu." },
        { img: "/img/portfolio/jewelry-web/gold-band-585-v3.webp", title: "Obrączka złota 585", category: "rings", desc: "Klasyczna obrączka ze złota próby 585 o szerokości 4mm, polerowana na wysoki połysk." },
        { img: "/img/portfolio/jewelry-web/garnet-ring-585-v2.webp", title: "Pierścionek z granatem", category: "rings", desc: "Pierścionek ze złota próby 585 z centralnie osadzonym czerwonym granatem 1,2 ct w towarzystwie sześciu cyrkonii 2,5mm." },
  ...
  studio: {
    ...
    aboutP1: "AEJaCA sTuDiO to techniczne i inżynieryjne ramię marki. Łączymy produkcję cyfrową z własnym modelowaniem 3D (Rhino, Fusion 360) — projektujemy zarówno organiczne formy biżuteryjne, jak i techniczne części funkcjonalne (projektowanie parametryczne, tolerancje mechaniczne, inżynieria odwrotna). Nie ograniczamy się do drukowania gotowych plików.",
    aboutP2: "Niezależnie czy potrzebujesz pojedynczego prototypu, małej serii produkcyjnej, czy w pełni dostosowanego rozwiązania technicznego — zaczynamy od szkicu, zdjęcia lub pomysłu i prowadzimy projekt od modelu CAD po gotowy produkt.",
    ...
    services: [
      "Modelowanie 3D od szkicu / zdjęcia / pomysłu (Rhino, Fusion 360)",
      "Projekt parametryczny, tolerancje mechaniczne i inżynieria odwrotna",
  ...
  contact: {
    ...
    thankYou: "Dziękujemy!",
    thankYouText: "Odezwiemy się do Ciebie wkrótce. W razie pilnej sprawy napisz bezpośrednio na contact@aejaca.com",
