export default {
  nav: {
    ...
    contact: "Kontakt",
    jewelrySections: [
      { label: "Über AEJaCA Schmuck", id: "about" },
      { label: "Produkte & Leistungen", id: "services" },
      { label: "Richtpreise", id: "pricing" },
      { label: "Preiskalkulator", id: "calculator" },
      { label: "FAQ", id: "faq" },
      { label: "Prozess", id: "process" },
      { label: "Portfolio", id: "portfolio" },
      { label: "Tipps & Wissen", id: "tips" },
      { label: "Glossar", to: "/glossary/?category=jewelry" },
    ...
    studioSections: [
      ...
      { label: "Wie Wir Arbeiten", id: "process" },
      { label: "Tipps & Wissen", id: "tips" },
      { label: "Glossar", to: "/glossary/?category=studio" },
  ...
  home: {
    ...
    jewelryDesc: "Silber, Gold, natürliche Edelsteine. Jedes Stück handgefertigt, nur für dich.",
    jewelryBtn: "Schmuck entdecken",
    studioTitle: "sTuDiO",
    studioSubtitle: "AEJaCA sTuDiO",
    studioDesc: "3D-Druck, Lasergravur, CNC-Fräsen. Hol dir ein Angebot online.",
    studioBtn: "sTuDiO betreten",
  ...
  jewelry: {
    ...
    aboutP1: "AEJaCA repräsentiert die künstlerische und luxuriöse Seite der Marke. Jedes Schmuckstück wird mit größter Liebe zum Detail handgefertigt und verbindet traditionelle Goldschmiedetechniken mit eigenem 3D-Modellieren in Rhino und Fusion 360. Organische Schmuckformen werden von Grund auf entworfen — von der Skizze oder dem Foto bis zur druck- oder gussfertigen Datei.",
    aboutP2: "Wir glauben, dass Schmuck Bedeutung tragen sollte. Jede Kreation durchläuft einen vollständigen Zyklus: Beratung → CAD-Modell → Wachsprototyp oder 3D-Druck → Wachsausschmelzguss → Handbearbeitung → Steinfassung. Jeder Schritt wird von Leidenschaft und Präzision geleitet.",
    ...
    portfolio: {
      ...
      items: [
        ...
        { img: "/img/portfolio/jewelry-web/sea-snail-pendant.webp", title: "Anhänger Meeresschnecke", category: "custom", desc: "Auf Sonderbestellung gefertigter Anhänger in Form einer symbolischen Meeresschnecke, Silber 925, an einem schwarzen Naturlederband." },
        { img: "/img/portfolio/jewelry-web/gold-band-585.webp", title: "Trauring Gold 585", category: "rings", desc: "Klassischer Trauring aus 585er Gold, 4mm breit, hochglanzpoliert." },
        { img: "/img/portfolio/jewelry-web/garnet-ring-585.webp", title: "Ring mit Granat", category: "rings", desc: "Ring aus 585er Gold mit zentral gefasstem roten Granat 1,2 ct, flankiert von sechs 2,5mm Zirkonia." },
  ...
  studio: {
    ...
    aboutP1: "AEJaCA sTuDiO ist der technische und ingenieurwissenschaftliche Arm der Marke. Wir verbinden digitale Fertigung mit eigenem 3D-Modellieren (Rhino, Fusion 360) — wir entwerfen sowohl organische Schmuckformen als auch funktionale technische Teile (parametrisches Design, mechanische Toleranzen, Reverse Engineering). Wir beschränken uns nicht aufs Drucken hochgeladener Dateien.",
    aboutP2: "Ob Sie einen einzelnen Prototyp, eine Kleinserie oder eine vollständig individualisierte technische Lösung benötigen — wir starten mit Ihrer Skizze, Ihrem Foto oder Ihrer Idee und begleiten das Projekt vom CAD-Modell bis zum fertigen Produkt.",
    ...
    services: [
      "3D-Modellierung von Skizze / Foto / Idee (Rhino, Fusion 360)",
      "Parametrisches Design, mechanische Toleranzen & Reverse Engineering",
  ...
  contact: {
    ...
    thankYouText: "Wir melden uns in Kürze. Für dringende Anfragen schreiben Sie uns direkt an contact@aejaca.com",
