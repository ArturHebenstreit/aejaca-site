export default {
  ...
  a11y: {
    ...
    krokiZamowienia: "Bestellschritte, seitlich scrollbar",
    closeLightbox: "Vergrößerung schließen",
    newsletter: "Newsletter-Anmeldung",
    newsletterStopka: "Newsletter-Anmeldung in der Fußzeile",
    listaWpisow: "Liste der Beiträge",
  ...
  nav: {
    ...
    studioSections: [
      ...
      { label: "Etsy-Shop Studio", href: "https://aejaca2studio.etsy.com" },
  ...
  home: {
    ...
    shopEntry: {
      tag: "Shop",
      title: "Online bestellen, ohne Angebots-E-Mail",
      subtitle: "Der Preis ist sofort verbindlich, Sie zahlen per Karte oder Sofortüberweisung. Keine Anfrageformulare, kein Warten auf Antwort.",
      readyHeading: "Auf Lager, sofort versandfertig",
      servicesHeading: "Online bestellt, verbindlicher Preis",
      cta: "Zum ganzen Shop",
    },
  ...
  orderStatus: {
    payNow: "Bestellung bezahlen",
    retryPayment: "Zahlung erneut versuchen",
    retryingPayment: "Zahlung wird geöffnet",
    retryFailed: "Eine weitere Zahlung konnte nicht gestartet werden. Versuchen Sie es erneut oder schreiben Sie uns.",
    retryUnavailable: "Die Zahlung kann über diesen Link nicht sicher neu gestartet werden. Schreiben Sie uns, dann prüfen wir die Bestellung und senden Ihnen einen neuen Link.",
  },
