    ...
    <footer className="bg-neutral-950 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-neutral-400 text-sm leading-relaxed">
              Artisan Elegance Jewelry and Crafted Art.
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link to="/jewelry" className="block text-sm text-neutral-300 hover:text-amber-400 transition-colors">
                AEJaCA Jewelry
              </Link>
              <Link to="/studio" className="block text-sm text-neutral-300 hover:text-blue-400 transition-colors">
                AEJaCA sTuDiO
              </Link>
              <Link to="/contact" className="block text-sm text-neutral-300 hover:text-white transition-colors">
                Contact
              </Link>
              <Link to="/privacy" className="block text-sm text-neutral-300 hover:text-white transition-colors">
                Privacy Policy
              </Link>
            </div>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/5 text-center text-neutral-500 text-xs">
          &copy; {new Date().getFullYear()} AEJaCA &mdash; Artisan Elegance Jewelry and Crafted Art. All rights reserved.
        </div>
      </div>
    </footer>
  );
