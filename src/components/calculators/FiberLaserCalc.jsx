...
// ============================================================
// Lenses: 70mm (field ~50×50mm = 25cm²) | 150mm (field ~110×110mm = ~121cm²)
...
const LBL = {
  pl: { material: "Materiał", lens: "Soczewka / pole robocze", markType: "Typ znakowania",
    ...
    discount: "Rabat seryjny", totalProd: "Czas produkcji łącznie",
...
const MATERIALS = [
  ...
  { id: "hardplast",  label: { pl: "Tworzywo twarde", en: "Hard plastic", de: "Hartkunststoff" },  rateMin: 0.05, precious: false },
...
export default function FiberLaserCalc({ lang = "pl" }) {
  ...
  // Auto-reset area if it exceeds lens field
  useEffect(() => {
    const area = AREAS.find(a => a.id === areaId);
  ...
  // Build area options with disabled state based on lens
