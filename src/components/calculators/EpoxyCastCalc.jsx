...
const RESINS = [
  ...
  { id: "pu",          label: { pl: "Poliuretan (PU)", en: "Polyurethane (PU)", de: "Polyurethan (PU)" },
    pricePerMl: 0.28, density: 1.08, cureH: 4,
    desc: { pl: "Sztywny, funkcjonalny, szybszy niż epoksyd", en: "Rigid, functional, faster than epoxy", de: "Starr, funktional, schneller als Epoxid" } },
...
const MOLD_TYPES = [
  { id: "existing", label: { pl: "Istniejąca forma", en: "Existing mold", de: "Vorhandene Form" },           moldCost: 0,   pourLife: 1 },
  { id: "new_s",    label: { pl: "Nowa forma — mała", en: "New mold — small", de: "Neue Form — klein" },     moldCost: 60,  pourLife: 40 },
  { id: "new_m",    label: { pl: "Nowa forma — średnia", en: "New mold — medium", de: "Neue Form — mittel" }, moldCost: 150, pourLife: 35 },
  { id: "new_l",    label: { pl: "Nowa forma — duża", en: "New mold — large", de: "Neue Form — groß" },      moldCost: 350, pourLife: 25 },
...
const INCLUSIONS = [
  ...
  { id: "object",   label: { pl: "Zalewany obiekt (kwiat, zdjęcie)", en: "Embedded object (flower, photo)", de: "Eingebettetes Objekt (Blume, Foto)" }, cost: 8 },
...
function calculate({ resinId, volumeId, moldId, inclusionId, finishId, quantityId }, lang) {
  ...
  const handleH = 0.05; // ~3min per piece
  ...
  // Batch time: work + cure per piece (cure can overlap for some pieces, but conservatively sequential)
