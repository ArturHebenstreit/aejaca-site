...
export const CHAIN_WEAVES = [
  ...
  { id: "cuban_link",label: { pl: "Kubański", en: "Cuban link", de: "Kubanische Kette" },
    ar: 3.2, widthMul: 6.5, thicknessMul: 2.5,
    weaveFactor: 1.8, laborMul: 1.3, materialWaste: 12, img: "/img/calc/weaves/cuban_link.webp" },
  ...
  { id: "spiga",     label: { pl: "Spiga / Kłos", en: "Spiga / Wheat", de: "Spiga / Ähre" },
    ar: 3.2, widthMul: 4.5, thicknessMul: 2.5,
    weaveFactor: 2.0, laborMul: 1.4, materialWaste: 12, img: "/img/calc/weaves/spiga.webp" },
