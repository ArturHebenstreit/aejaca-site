...
export const CHAIN_WEAVES = [
  { id: "klasyczny",  label: { pl: "Klasyczny", en: "Classic", de: "Klassisch" },
    ar: 4.0, widthMul: 6.0, thicknessMul: 2.0,
    weaveFactor: 1.0, laborMul: 0.8, materialWaste: 5,  img: "/img/calc/weaves/klasyczny.webp" },
  { id: "ankier",    label: { pl: "Ankier", en: "Anchor", de: "Anker" },
    ar: 4.5, widthMul: 7.0, thicknessMul: 2.0,
    weaveFactor: 1.4, laborMul: 1.0, materialWaste: 8,  img: "/img/calc/weaves/ankier.webp" },
  { id: "figaro",    label: { pl: "Figaro", en: "Figaro", de: "Figaro" },
    ar: 4.0, widthMul: 6.0, thicknessMul: 2.0,
    weaveFactor: 1.6, laborMul: 1.2, materialWaste: 10, img: "/img/calc/weaves/figaro.webp" },
  { id: "pancerz",   label: { pl: "Pancerka", en: "Curb", de: "Panzer" },
    ar: 3.2, widthMul: 5.0, thicknessMul: 1.5,
    weaveFactor: 1.5, laborMul: 1.1, materialWaste: 9,  img: "/img/calc/weaves/pancerz.webp" },
  { id: "cuban_link",label: { pl: "Kubański", en: "Cuban link", de: "Kubanische Kette" },
    ar: 3.5, widthMul: 7.5, thicknessMul: 1.5,
    weaveFactor: 1.7, laborMul: 1.3, materialWaste: 12, img: "/img/calc/weaves/cuban_link.webp" },
  { id: "rolo",      label: { pl: "Rolo", en: "Rolo / Belcher", de: "Rolo" },
    ar: 4.0, widthMul: 6.0, thicknessMul: 2.5,
    weaveFactor: 1.2, laborMul: 0.9, materialWaste: 7,  img: "/img/calc/weaves/rolo.webp" },
  { id: "kordel",    label: { pl: "Kordel (lina)", en: "Rope", de: "Kordel" },
    ar: 2.8, widthMul: 3.5, thicknessMul: 3.5,
    weaveFactor: 2.5, laborMul: 1.7, materialWaste: 18, img: "/img/calc/weaves/kordel.webp" },
  { id: "lisi_ogon", label: { pl: "Lisi ogon", en: "Foxtail", de: "Fuchsschwanz" },
    ar: 3.2, widthMul: 4.0, thicknessMul: 2.5,
    weaveFactor: 2.8, laborMul: 1.8, materialWaste: 18, img: "/img/calc/weaves/lisi_ogon.webp" },
  { id: "gucci",     label: { pl: "Gucci", en: "Gucci link", de: "Gucci" },
    ar: 4.5, widthMul: 7.0, thicknessMul: 2.0,
    weaveFactor: 1.5, laborMul: 1.1, materialWaste: 10, img: "/img/calc/weaves/gucci.webp" },
  { id: "bizmark",   label: { pl: "Bizmark", en: "Bismark", de: "Bismark" },
    ar: 3.2, widthMul: 8.0, thicknessMul: 2.0,
    weaveFactor: 2.2, laborMul: 1.5, materialWaste: 15, img: "/img/calc/weaves/bizmark.webp" },
  { id: "byzantine", label: { pl: "Bizantyjski", en: "Byzantine", de: "Byzantinisch" },
    ar: 4.5, widthMul: 5.0, thicknessMul: 3.0,
    weaveFactor: 3.2, laborMul: 2.2, materialWaste: 22, img: "/img/calc/weaves/byzantine.webp" },
  { id: "franco",    label: { pl: "Franco", en: "Franco", de: "Franco" },
    ar: 2.8, widthMul: 4.0, thicknessMul: 4.0,
    weaveFactor: 2.0, laborMul: 1.5, materialWaste: 15, img: "/img/calc/weaves/franco.webp" },
