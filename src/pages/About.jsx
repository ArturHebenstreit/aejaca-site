...
const LABELS = {
  pl: {
    ...
    description: "AEJaCA łączy rzemiosło jubilerskie z własnym modelowaniem 3D (Rhino, Fusion 360) i fabrykacją cyfrową (druk 3D, laser, odlewy). Od 2023 roku, 150+ projektów, 5.0 na Google.",
  ...
  en: {
    ...
    description: "AEJaCA combines jewelry craft with in-house 3D modeling (Rhino, Fusion 360) and digital fabrication (3D printing, laser, casting). Since 2023, 150+ projects, 5.0 on Google.",
    bioTitle: "Artur Hebenstreit",
  ...
  de: {
    ...
    description: "AEJaCA verbindet Schmuckhandwerk mit eigenem 3D-Modellieren (Rhino, Fusion 360) und digitaler Fertigung (3D-Druck, Laser, Guss). Seit 2023, 150+ Projekte, 5,0 auf Google.",
    bioTitle: "Artur Hebenstreit",
