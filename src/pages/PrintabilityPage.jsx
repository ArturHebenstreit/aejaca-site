...
const FAQ = {
  pl: [
    { q: "Czy mój plik gdzieś trafia?", a: "Nie. Cała analiza dzieje się w Twojej przeglądarce, w osobnym wątku roboczym. Plik nie jest wysyłany na żaden serwer, nie zapisujemy go i nie mamy do niego dostępu. Możesz sprawdzić: odetnij internet po wczytaniu strony, narzędzie nadal zadziała. Jeden wyjątek warto znać: jeżeli przyszedłeś tu z konfiguratora, model przejechał do tej karty przez pamięć Twojej przeglądarki, żebyś nie musiał wgrywać go drugi raz. Ten zapis leży na Twoim dysku, kasujemy go w chwili odczytania i wygasa po kwadransie." },
  ...
  en: [
    { q: "Does my file go anywhere?", a: "No. The whole analysis runs in your browser, in a separate worker thread. The file is not uploaded to any server, we do not store it and we have no access to it. You can verify this: disconnect from the internet after the page loads and the tool still works. One exception is worth knowing: if you came here from the configurator, the model travelled to this tab through your browser's own storage, so you would not have to upload it twice. That record sits on your disk, we delete it the moment it is read and it expires after fifteen minutes." },
    { q: "What is the minimum wall thickness with a 0.4 nozzle?", a: "One path is 0.4 mm and that much will print. A functional wall wants two paths, about 0.84 mm, because a single path has no cross-binding and cracks under pressure. Below 0.4 mm the printer has nothing to lay down and a hole is left. Context matters: lettering, texture or a chamfer below the threshold is not a wall and we do not treat it as a defect. Such detail simply comes out rounded." },
