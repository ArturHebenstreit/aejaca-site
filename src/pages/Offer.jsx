...
const UI = {
  pl: {
    ...
    payNote: "Płatność obsługuje Autopay: BLIK, karta albo przelew online. Tytułem płatności jest numer tej oferty.",
  ...
  en: {
    ...
    payNote: "Payment is handled by Autopay: BLIK, card or online transfer. The payment title is the number of this offer.",
  ...
  de: {
    ...
    payNote: "Die Zahlung wickelt Autopay ab: BLIK, Karte oder Online-Überweisung. Verwendungszweck ist die Nummer dieses Angebots.",
