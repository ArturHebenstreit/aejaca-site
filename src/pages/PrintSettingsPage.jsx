...
const LABELS = {
  pl: {
    ...
    heroTitle: "Parametry druku 3D FDM i dobór materiału",
    ...
    breadThis: "Parametry druku 3D FDM",
  ...
  en: {
    ...
    heroTitle: "FDM 3D Print Settings & Material Advisor",
    ...
    breadThis: "3D Print Settings FDM",
  ...
  de: {
    ...
    heroTitle: "FDM-3D-Druckparameter & Materialberater",
    ...
    breadStudio: "sTuDiO",
    breadTools: "sTuDiO-Tools",
    breadThis: "3D-Druckparameter FDM",
...
const SEO_META = {
  pl: {
    title: "Parametry druku 3D FDM: PLA, PETG, ABS, PA-CF | AEJaCA",
...
export default function PrintSettingsPage() {
  ...
  const schemas = [
    buildWebPageSchema({
      ...
      url: adresStrony("/toolstudio/print-settings/", lang),
    }),
    buildBreadcrumbSchema([
      ...
      { name: L.breadThis, url: adresStrony("/toolstudio/print-settings/", lang) },
    ]),
  ];
