...
const FAQ = {
  pl: [
    ...
    { q: "Czy kartę można zwrócić albo wymienić na gotówkę?", a: "Karty nie wymieniamy na gotówkę. Jeżeli jednak nie została jeszcze w żaden sposób wykorzystana, a od zakupu nie minęło 14 dni, napisz do nas i to rozwiążemy." },
  ],
  en: [
    ...
    { q: "Can a card be returned or exchanged for cash?", a: "We do not exchange cards for cash. If it has not been used in any way and fewer than 14 days have passed since purchase, write to us and we will sort it out." },
  ],
  de: [
    ...
    { q: "Kann eine Karte zurückgegeben oder in bar ausgezahlt werden?", a: "Wir zahlen Karten nicht in bar aus. Wurde sie noch in keiner Weise genutzt und liegt der Kauf weniger als 14 Tage zurück, schreiben Sie uns und wir finden eine Lösung." },
  ],
};
