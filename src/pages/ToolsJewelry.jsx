...
const LABELS = {
  pl: {
    ...
    tool2Title: "Ile warte jest moje złoto",
    tool2Desc: "Wartość kruszcu z ceny spot i realne widełki skupu, próby 333 do 999",
  ...
  en: {
    ...
    tool2Title: "What is my gold worth",
    tool2Desc: "Metal value from the spot price and a realistic buy-back range, fineness 333 to 999",
  ...
  de: {
    ...
    tool2Title: "Was ist mein Gold wert",
    tool2Desc: "Materialwert aus dem Spotpreis und realistische Ankaufsspanne, Feingehalt 333 bis 999",
