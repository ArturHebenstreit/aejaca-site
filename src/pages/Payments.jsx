...
const L = {
  pl: {
    ...
    offerSteps: [
      ...
      ["Widzisz ofertę", "Pozycje, kwoty jednostkowe, nasza notatka co wchodzi w zakres, i termin ważności."],
  ...
  en: {
    ...
    offerSteps: [
      ...
      ["You see the offer", "The items, unit amounts, our note on what is and is not included, and the expiry date."],
  ...
  de: {
    ...
    offerSteps: [
      ...
      ["Sie sehen das Angebot", "Positionen, Einzelbeträge, unsere Notiz zum Umfang und das Ablaufdatum."],
