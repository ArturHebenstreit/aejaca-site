...
**Precious-metal casting product, Build 1.004:** route 1 is casting a supplied ready wax or castable-resin pattern; route 2 is printing and casting an uploaded STL/OBJ/3MF/STEP model; route 3 is CAD, pattern and casting from the customer's idea. All routes support Ag 800/925 and Au 9k/14k/18k/24k, using AEJaCA or supplied metal. Only route 2 with AEJaCA metal can receive an automatic binding price, because volume is measured server-side. Automatic casting limit: 24 x 24 x 35 mm after orientation. Physical patterns, idea-only work, models over the limit and supplied metal need a human quote. For supplied metal explain a typical 5-8% technological loss for clean single-alloy stock and 10-15% for mixed or uncertain stock; plated or filled material may be refused. Page: https://www.aejaca.com/shop/service/precious_metal_casting/ .
