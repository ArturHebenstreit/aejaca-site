...
**Metals:** Silver 925/800, Gold 9K-24K. **No platinum** (missing equipment: higher-temperature torch, platinum solder, separate casting tooling). If a customer asks for platinum, say plainly that we do not make it and propose white gold 585/750 with rhodium plating as the closest look. **Clasps priced separately** (spring ring, lobster, barrel, toggle, custom).
