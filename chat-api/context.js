...
- Sklep ma TRZY rodzaje oferty: **produkty gotowe** (lezą na polce, pakujemy i wysylamy), **gotowe personalizowane** (polprodukt lezy na polce, dopasowujemy go do klienta: kamienne podstawki, drewniane szkatulki, deski z grawerem, termin w dniach) oraz **uslugi** (wykonujemy od nowa, termin w tygodniach). Nie mylic personalizacji z usluga: przy podstawce baza istnieje, przy pierscionku nie
