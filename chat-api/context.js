...
- **On AEJaCA material**: the client PICKS the material from a list, and the pick changes the price. CO2 engraving: wood, plywood, acrylic, glass, leather, paper, fabric, rubber, stone. CO2 cutting, with thickness because it drives the price: plywood 2/3/5/8 mm, acrylic 3/5/8 mm, leather 1-2 mm and 3-4 mm, paper/cardboard, fabric/felt, rubber 2-3 mm. Fiber: stainless steel, aluminium, anodised aluminium, brass, copper, titanium. Silver and gold are engraved but NOT supplied from our stock, so they are not on this list. "Other material" is always available and opens a free-text field. Availability and the price of the material itself are confirmed at the start of the job; the calculator amount covers the work only. Nothing is shipped to us.
