...
- **Oferta bywa do skonfigurowania.** Pozycja jest wtedy jednym z trzech: składnikiem rachunku (zawsze w kwocie), wariantem na karcie (z jednej karty klient bierze DOKŁADNIE JEDEN) albo dodatkiem (klient dokłada go albo nie). Kart może być kilka obok siebie, na przykład "pierścionek albo sygnet albo obrączka" i osobno "figurka albo szkatułka", a przy karcie mogą stać dodatki, na przykład polerowanie. Kwota do zapłaty dopasowuje się do zaznaczenia, wybór da się zmieniać aż do zapłaty, a do zamówienia trafiają WYŁĄCZNIE pozycje zaznaczone. Rabat liczy się od zaznaczonego układu, nie od sumy propozycji, a każda zmiana układu kasuje podgląd zniżki, więc kod trzeba wpisać jeszcze raz. Termin ważności jest wspólny dla całej oferty. NIE zgaduj, co konkretna oferta zawiera ani ile kosztuje: klient widzi to na swojej stronie.
