...
| TASK-004 | `codex/ring-setting-refinement` | Claude Code | zakrycie kaset, kieszenie pod kamienie, skala krap, halo, testy geometrii i pelny build | oczekuje |\n| TASK-005 | `codex/ring-ux-signet-refinement` | Claude Code | gniazda przelotowe, rozroznienie stopow, ergonomia, wersja builda, zintegrowane sygnety i pelny build | oczekuje |
