...
| TASK-007 | Odlew z metali szlachetnych w trzech wariantach | Codex | `codex/precious-metal-casting-service` | katalog i karta uslugi odlewniczej, skalowanie do limitu odlewni, dynamiczna cena karty, lokalizacja komunikatow, formaty i przeciaganie plikow, silnik i mirrory wyceny, `ServiceConfigurator.jsx`, testy odlewu, grafika produktu, regulaminy i SEO | review | `MDs/handoffs/TASK-007-precious-metal-casting.md` |
